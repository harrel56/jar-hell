...
class LicenseTypeTest {
    ...
    private static Stream<Arguments> licenses() {
        return Stream.of(
                ...
                // a version-less apache name falls back to 2.0, but an explicit 1.1 in name or url wins
                Arguments.of(new License("Apache License", "LICENSE.txt"), LicenseType.APACHE_2),
                Arguments.of(new License("ASL, version 2", "http://www.apache.org/licenses/"), LicenseType.APACHE_2),
                Arguments.of(new License("Apache  Version 2.0, January 2004", null), LicenseType.APACHE_2),
                Arguments.of(new License("The Apache Software License, Version 1.1", null), LicenseType.APACHE_1_1),
                Arguments.of(new License("Apache License", "http://www.apache.org/licenses/LICENSE-1.1.txt"), LicenseType.APACHE_1_1),
                Arguments.of(new License("Mozilla Public License", "http://www.mozilla.org/MPL/MPL-1.1.html"), LicenseType.MPL_1),
                Arguments.of(new License("Bouncy Castle Licence", null), LicenseType.MIT),
                Arguments.of(new License("EDL 1.0", null), LicenseType.EDL_1),
                Arguments.of(new License("Eclipse Distribution License v. 1.0", null), LicenseType.EDL_1),
                Arguments.of(new License("Eclipse Distribution License - v 1.0", "http://www.eclipse.org/org/documents/edl-v10.php"), LicenseType.EDL_1),
                // distribution and public licenses are unrelated despite the similar names
                Arguments.of(new License("Eclipse Public License - v 1.0", null), LicenseType.EPL_1),
